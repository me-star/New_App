...
<head>
    ...
    <title>NewApp - <?php echo $title ?></title>
</head>
<body>
    <div class="container">
    ...
    <li class="nav-item"><a class="nav-link" href="whiledowhile.php">Simple While Loop</a></li>
    ...
    <li class="nav-item"><a class="nav-link" href="datetimemanip.php">Date and Time Manipulation</a></li>
